...
public abstract class ReloadablePrimary : Primary, IReloadable
{
    protected ReloadablePrimary(GunType gunType, int maxAmmo, int damage, double rateOfFirePerSecond, int magazineSize, double reloadTime)
